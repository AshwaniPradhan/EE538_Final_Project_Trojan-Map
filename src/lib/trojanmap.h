...
class TrojanMap {
 public:
  ...
  double CalculatePathLength(const std::vector<std::string> &path);
    ...
    //helper
    std::string find_min_unvisited(std::unordered_map<std::string, double> &dist, std::vector<std::string> &visited);
  ...
  bool has_cycle(std::string current_id,std::map<std::string,bool> &visited, std::string parent_id,std::vector<double> &square);
  ...
  void TravelBruteForce(std::string origin, std::vector<std::string> &location_ids, std::string curr_node, double curr_cost, 
                                  std::vector<std::string> &curr_path, std::pair<double, std::vector<std::vector<std::string>>> &records);
  std::pair<double, std::vector<std::vector<std::string>>> TravellingTrojan_Brute_force(
      std::vector<std::string> location_ids);
  
void TravelBacktrack(std::string origin, std::vector<std::string> &location_ids, std::string curr_node, double curr_cost, 
                                  std::vector<std::string> &curr_path, std::pair<double, std::vector<std::vector<std::string>>> &records );
  ...
  std::pair<double, std::vector<std::vector<std::string>>> TravellingTrojan_2opt(
      std::vector<std::string> location_ids);
std::vector<std::string> Helper_2_opt(const std::vector<std::string> &path, int i, int k);
...
double helper_3opt(std::vector<std::string> &route, int i, int j, int k, std::pair<double, std::vector<std::vector<std::string>>> &records);
  ...
  bool has_cycle(std::string curr,std::unordered_map<std::string, bool> &marked, std::string parent);
  ...
  // Helper function to reverse the sub part if it is better (For 2-opt function)
 // double Helper_2_opt(std::vector<std::string> &route_2, int t_1, int t_2, std::pair<double, std::vector<std::vector<std::string>>> &records);
